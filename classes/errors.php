...
class errorsEbbs {
    ...
    static public function setSession($error) {
        ...
        if(is_array($error))
            ...
            $sesErrors[] = $error;
        reqEbbs::setVar('sesErrors', $sesErrors, 'session');
    }
    static public function init() {
        $bupErrors = reqEbbs::getVar('ebbsErrors');
        if(!empty($bupErrors)) {
            ...
            if(!empty($bupErrors)) {
                ...
                add_filter('the_content', array('errorsEbbs', 'appendErrorsContent'), 99999);
            }
        }
    }
    ...
    static public function getSession() {
        return reqEbbs::getVar('sesErrors', 'session');
    }
    static public function clearSession() {
        reqEbbs::clearVar('sesErrors', 'session');
    }
