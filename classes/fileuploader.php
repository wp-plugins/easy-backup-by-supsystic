<?php
	class fileuploaderEbbs {
		...
		public function getError() {
			return __($this->_error, EBBS_LANG_CODE);
		}
		...
		public function upload() {
            ...
            if (isset($upload['type']) && !empty($upload['type'])) {
                ...
                //$this->_fileInfo['id'] = frameEbbs::_()->getTable('files')->insert($data_to_store);
                $res = true;
        ...
        private function createFileName() {
            return utilsEbbs::getRandStr(). '-'. utilsEbbs::getRandStr(). '-'. utilsEbbs::getRandStr(). '-'. utilsEbbs::getRandStr();
        }
        /**
