...
class warehouseEbbs extends moduleEbbs
{

    /**
     * @var warehouseModelEbbs
     */
    private $folder;

    /**
     * @var temporaryModelEbbs
     */
    private $temporary;
    ...
    public function _noticeNotWritable()
    {
        ...
        $message = sprintf(
            __('Folder "%s" is not writable.', EBBS_LANG_CODE),
            $path
        );
    ...
    public function _noticeCantCreate()
    {
        ...
        $message = sprintf(
            __('Can\'t create warehouse directory "%s".', EBBS_LANG_CODE),
            $path
        );
